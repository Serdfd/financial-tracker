...
function migraciones() {
  // Emoji en categorias — para BDs anteriores a este campo
  ...
  // retencion_pct en fichas_inversion — para BDs anteriores
  ...
  // Columnas nuevas en inmuebles — para BDs anteriores
